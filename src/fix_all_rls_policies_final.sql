-- =====================================================
-- COMPREHENSIVE RLS POLICY FIX (FINAL CORRECTED VERSION)
...
-- =====================================================
-- DEPARTMENTS POLICIES (using department_id)
-- =====================================================
...
-- =====================================================
-- USER_PROFILES POLICIES (using user_id)
-- =====================================================
...
WITH CHECK (
  ...
  EXISTS (
    SELECT 1 
    FROM invite_codes 
    WHERE department_id = user_departments.department_id 
    AND email = (
      SELECT email 
      FROM auth.users 
      WHERE id = auth.uid()
